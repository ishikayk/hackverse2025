...
const RoadmapPage: React.FC = () => {
  ...
  return (
    <div className="w-screen h-screen flex">
      <div className="fixed top-25 w-[60em] bg-zinc-100 z-50">
        <h2 className="text-4xl font-bold py-4 fixed left-[25rem] z-50">
          Your Personalized Roadmap 
        </h2>
        <button
          onClick={() => navigate('/chat', { state: { roadmap: roadmapData } })}
          className="bg-gradient-to-br from-rose-500 to-pink-400 hover:bg-gradient-to-br hover:from-rose-700 hover:to-pink-600 text-white px-8 py-4 w-[12rem] h-[4rem] ml-[2rem] rounded-lg font-medium transition-colors fixed top-24 right-[25rem] flex justify-center items-center gap-2"
        >
          Ask a Doubt
      ...
      <button
            ...
            className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:bg-gradient-to-r hover:from-purple-700 hover:to-indigo-700 text-white px-8 py-4 rounded-lg font-medium fixed top-[6.2em] right-[12rem] z-50"
          >
            Take Final Quiz
          </button>
        <Progress />
